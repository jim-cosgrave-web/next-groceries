...
import { UPDATE_STORE_GROCERY_API_METHOD, UNCATEGORIZED, REORGANIZE_STORE_GROCERIES_API_METHOD, UPDATE_STORE_CATEGORY_API_METHOD, DELETE_STORE_CATEGORY_API_METHOD, ADD_STORE_GROCERY_API_METHOD } from '../../util/constants';
        ...
        try {
            ...
            if (req.method === 'GET') {
                ...
                if(req.body.method === ADD_STORE_GROCERY_API_METHOD) {
                    ...
                    const resp = await collection.updateOne(filter, push);
